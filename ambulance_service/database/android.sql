...
MySQL - 10.4.25-MariaDB : Database - ambulance_service
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`ambulance_service` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `request` (
  ...
  `ambulace_id` int(11) DEFAULT NULL,
