...
//	private String[] status;
	 ...
	 public CustomComplaint(Activity context, String[] dr, String[] pls, String[] ph) {
	        //constructor of this class to get the values from main_activity_class

	        super(context, R.layout.custom_complaint,dr);
...
//		 this.status = stat;
	    ...
	    public View getView(int position, View convertView, ViewGroup parent) {
	        ...
	        View listViewItem = inflater.inflate(R.layout.custom_complaint, null, true);
