...
public class CustomRequest extends ArrayAdapter<String>  {
	...
	private String[] status;
	 ...
	 public CustomRequest(Activity context, String[] dr, String[] pls, String[] ph, String[] deta , String[]amt,String[]dates,String[]stat) {
	        //constructor of this class to get the values from main_activity_class

	        super(context, R.layout.custom_request,dr);
	    ...
	    public View getView(int position, View convertView, ViewGroup parent) {
	        ...
	        View listViewItem = inflater.inflate(R.layout.custom_request, null, true);
...
//	        ImageView im = (ImageView) listViewItem.findViewById(R.id.imageView1);
		...
		TextView t2=(TextView)listViewItem.findViewById(R.id.TextView2);
			...
			t1.setText("Name : "+driver[position]);
