...
public class CustomUser extends ArrayAdapter<String>  {
	...
	private String[] email;
	 ...
	 public CustomUser(Activity context, String[] dr, String[] pls,String[] ph,String[] emai) {
	        //constructor of this class to get the values from main_activity_class

	        super(context, R.layout.custom_user,dr);
	    ...
	    public View getView(int position, View convertView, ViewGroup parent) {
	        ...
	        View listViewItem = inflater.inflate(R.layout.custom_user, null, true);
